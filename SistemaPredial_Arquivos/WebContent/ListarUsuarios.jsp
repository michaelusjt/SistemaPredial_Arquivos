...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            ...
            <div id="main" class="container">
                ...
                <button class="btn btn-primary" type="submit" name="command" value="ListarUsuariossBuscar">
                            ...
                            <tbody>
          					<c:forEach var="usuario" items="${lista }">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                <a class="btn btn-success btn-xs" href="controller.do?command=VisualizarCliente&id=${usuario.id }">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="controller.do?command=EditarCliente&id=${usuario.id }">Editar</a>
                                                <button id="btn${usuario.id }%>" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-cliente="${cliente.id }">Excluir</button>
                                            </td>
                                        </tr>             
                            </c:forEach>
